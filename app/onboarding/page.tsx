...
export default function OnboardingPage() {
    ...
    const [answers, setAnswers] =
        useState<Answers>(INITIAL_ANSWERS);
    ...
    const [transitioning, setTransitioning] =
        useState(false);
    const [loaderExiting, setLoaderExiting] =
        useState(false);
     ...
     *
     * The loader stays visible for exactly 7 seconds.
     */
    useEffect(() => {
        if (!isLoader) return;
    ...
    return (
        <>
            ...
            >
                {/* EXACT SAME BACKGROUND DECOR AS AUTH */}
                <div
                ...
                <main className="lm-main">
                    <section
                        className={`lm-card ${transitioning ||
                            loaderExiting
                            ? "is-transitioning"
                            : ""
                            }`}
                        style={{
                            transform: `translate3d(${parallax.x * 7
                                }px, ${parallax.y * 7
                                }px, 0)`,
                        }}
                    >
                        ...
                        {isQuestion && (
                            <div
                                key={`question-${step}`}
                                className={`lm-question ${transitioning
                                    ? "question-out"
                                    : "question-in"
                                    }`}
                            >
                                ...
                                <div className="lm-heading-area">
                                    <h1 className="lm-title">
                                        ...
                                        <span
                                            className={`lm-caret ${typedText.length >=
                                                currentQuestion
                                                    .title
                                                    .length
                                                ? "caret-done"
                                ...
                                <div
                                    className={`lm-options ${showOptions
                                        ? "options-visible"
                                        : "options-hidden"
                                        }`}
                                >
                                    {currentQuestion.options.map(
                                        (
                                            ...
                                            >
                                                ...
                                                <span className="lm-option-arrow">
                                                    →
                                                </span>
                                            </button>
                                        )
                        ...
                        {isLoader && (
                            <div
                                className={`lm-loader ${loaderExiting
                                    ? "loader-out"
                                    : "loader-in"
                                    }`}
                            >
                                <div className="lm-spinner-wrap">
                                    <div
                                        className="lm-spinner"
                                        aria-hidden="true"
                                    >
                                        <div className="lm-spinner-inner" />
                                    </div>
                                </div>
                        ...
                        {isComplete && (
                            <div className="lm-complete">
                                ...
                                >
                                    ...
                                    <span className="lm-continue-arrow">
                                        →
                                    </span>
                                </button>
        ...
        .lm-root {
          ...
          /*
           * EXACT SAME BACKGROUND AS AUTH PAGE
           */
          background: #7a2f00;
        ...
        .lm-question.question-in {
          animation: questionIn 650ms
            cubic-bezier(0.22, 1, 0.36, 1)
            both;
        }

        .lm-question.question-out {
          animation: questionOut 600ms
        ...
        .lm-options.options-visible
          .lm-option {
          animation: optionIn 500ms
            cubic-bezier(0.22, 1, 0.36, 1)
            both;
        }

        .lm-options.options-visible
          .lm-option:nth-child(2) {
        ...
        .lm-loader.loader-in {
          animation: loaderIn 600ms
            cubic-bezier(0.22, 1, 0.36, 1)
            both;
        }

        .lm-loader.loader-out {
          animation: loaderOut 450ms
            cubic-bezier(0.55, 0, 0.85, 0.35)
            both;
        }
        ...
        .lm-spinner-wrap {
          ...
          margin-bottom: 30px;
          border-radius: 50%;
          background: rgba(122, 47, 0, 0.035);
          box-shadow:
            0 0 0 12px
              rgba(122, 47, 0, 0.018),
            0 18px 45px
        ...
        .lm-loading-line span {
          ...
          /*
           * Automatically matches the 7-second loader.
           */
